#C Black Rockfish California 2023 Assessment
#C Stock_Synthesis_v3.30.21
black_rockfish_Northern_CA_2023_data.ss
black_rockfish_Northern_CA_2023_control.ss
...
8 # min age for calc of summary biomass (set close to age at 50% functional maturity per C. Rosemond)
...
0 # ALK tolerance, if model run times are slow, explore small value (example 0.0001)
