...
#C file write time: 2020-11-20 13:06:45
2021_wa_quillback.dat
2021_wa_quillback.ctl
...
-1 # min yr for sdreport outputs (-1 for styr); #_1931
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1605906770
