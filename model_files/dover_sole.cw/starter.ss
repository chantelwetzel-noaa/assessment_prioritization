...
#C Dover Sole 2021 assessment: Chantel Wetzel & Aaron Berger
2021_dover.dat
2021_dover.ctl
...
-1 # min yr for sdreport outputs (-1 for styr); #_1911
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1612368843
