...
A number of revisions have been made to the methodologies applied in the stock assessment prioritization this cycle that were aimed at simplifying the scoring, improving the scoring to better reflect the current fishery or biology, and how the material is presented.
...
* Constituent Demand
  ...
  + Scoring for potential choke species was simplified to be representative of projected future Annual Catch Limits (ACLs) attainment compared to current average catches.

* Assessment Frequency
  + Maximum age is now used in calculation to determine target assessment frequency. The previous approach used the estimated mean age of the catch. The new approach now more directly links biology to the determination of assessment frequency and can be applied to assessed and unassessed species.
