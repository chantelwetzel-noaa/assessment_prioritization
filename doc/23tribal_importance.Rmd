...
t = table_format(tab, 
             caption = c('Subsistence score by species. The subsitance score is colored reflecting low to high scores ranging between blue to yellow, respectively.'),
             label = 'sub-score',
             col_names = col_names,
             digits = 2,
             align = c('l','c'),
...
t %>%
    kableExtra::column_spec(2, 
        ...
        alpha = 0.25, begin = 0.1, end = 1, option = 'D', direction = 1))
